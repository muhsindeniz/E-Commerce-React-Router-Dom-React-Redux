                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            <img src={cloth_1} alt="Image" className="img-fluid" />
                        </div>
                        <div className="col-md-6">
                            ...
                            <div className="mb-5">
                                <div className="input-group mb-3" style={{ maxWidth: "120px" }} >
                                    <div className="input-group-prepend">
                                        <button className="btn btn-outline-primary js-btn-minus" type="button" onClick={() => dispatch({ type: "DECREMENT_PIECE" })}>&#8722;</button>
                                    </div>
                                    <input type="text" className="form-control text-center" value={piece} min="0" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                                    <div className="input-group-append">
                                        <button className="btn btn-outline-primary js-btn-plus" type="button" onClick={() => dispatch({ type: "INCREMENT_PIECE" })}>&#43;</button>
                                    </div>
                                </div>

                            </div>
                            <p><Link to='/card'><div href="cart.html" className="buy-now btn btn-sm btn-primary" onClick={() => dispatch({type: "ECOM_ON"})}>Add To Cart</div></Link></p>
